...
const displayStr = `A total of $${totalAmountRaised.toLocaleString()} for ${GAMES_JSON.length} games. Currently, ${unfundedGamesCount} ${displayStringContdition} remain unfunded.`;
if (unfundedGamesCount > 0) {
